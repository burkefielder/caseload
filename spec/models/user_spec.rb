...
RSpec.describe User, type: :model do
  describe 'A user' do
    ...
    it 'accepts properly formatted mail addresses' do
    ...
    it 'does nto require a password when updating' do
    ...
    it 'automatic encrypts the password into the password_digest attribute' do
